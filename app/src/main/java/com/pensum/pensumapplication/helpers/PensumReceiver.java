 ...
 */
public class PensumReceiver extends ParseBroadcastReceiver {

    private static final String TAG = "PensumReceiver";
...
//                        createNotification(context, value);
                        ...
                        launchConversationsFragment(context, value);
...
//    }
    ...
    private void launchConversationsFragment(Context context, String datavalue) {
        Intent pupInt = new Intent(context, ConversationFragment.class);
